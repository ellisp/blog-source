...
I've looked previously at the [sampling distribution of Gini coefficient](/blog/2015/09/12/inequality-stats-distributions), but only with unweighted data.  Reading Duoba and MacGibbon's paper reminded me that I should probably look at the realistic situation of estimating Gini coefficient with weighted data from a complex survey.
