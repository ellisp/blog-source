...
src="http://www.youtube.com/embed/R1ayXHfK3OY?autoplay=1&mute=1&playlist=R1ayXHfK3OY&loop=1&vq=hd1080" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
</iframe>
{:/nomarkdown}

(I suggest turning up the definition to 1080p, particularly if you zoom it up to full screen; I couldn't find a way to set the definition this myself, Google seems to have deliberately decided to make this an end-user choice.)
