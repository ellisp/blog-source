...
For improving this, a lot depends on the 2024 census.
...
pop_anu |> 
  ...
  mutate(variable = fct_relevel(variable, "UN")) |>   ggplot(aes(x = year, y = value, colour = variable)) +
