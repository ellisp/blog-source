...
#non-pharmaceutical interventions: second step roadmap metro Melbourne, stage 4,
#masks, stage 3, stage 3 (selected suburbs)
npi_dates <- as.Date(c("2020/09/27", "2020/08/03", "2020/07/22", "2020/07/10", "2020/07/01"))
