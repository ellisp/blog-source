...
fixture <- tibble(
  home = c("Adelaide", "Melbourne", "Carlton", "GWS", "Brisbane Lions", "Collingwood",
           "Footscray", "Hawthorn", "Fremantle"),
  away = c("Geelong", "Essendon", "Sydney", "Richmond", "Port Adelaide", "West Coast", "Gold Coast", 
